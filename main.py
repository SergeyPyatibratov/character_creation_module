...
if __name__ == '__main__':
    """Запусти заставку. Получи имя героя.
    Вызови функцию для выбора класса героя.
    """
    run_screensaver()
